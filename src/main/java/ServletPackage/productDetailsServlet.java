...
public class productDetailsServlet extends HttpServlet {
    ...
    @EJB
    EJBPackage.productDetailsEJB pde;
...
//            String dateString = "20-04-2024";
//            SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
//            try {
//                Date date = dateFormat.parse(dateString);
//                System.out.println("Converted Date: " + date);
//                pde.addProductDetails("Vivo v20", 10, 20000, "test", date, "1 year", 3, 1);
...
//            String dateString = "22-04-2024";
//            SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
//            try {
//                Date date = dateFormat.parse(dateString);
//                System.out.println("Converted Date: " + date);
//                pde.updateProduct(1,"Vivo y55", 15, 19000, "check", date, "2 year", 3, 2);
//            } catch (ParseException e) {
//                e.printStackTrace();
//            }
